...
//
// This component contains the content for the "Help us to improve Go3d Transform" page of the welcome on-boarding process.
...
Item
{
    UM.Label
    {
        ...
        text: "Help us to improve Go3d Transform"
    ...
    Item
    {
        ...
        Column
        {
            ...
            UM.Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: "Go3d Transform collects anonymous data to improve print quality and user experience, including:"
            ...
            UM.Label
            {
                ...
                text:
                {
                    var t = "Data collected by Go3D Transform will not contain any personal information."
